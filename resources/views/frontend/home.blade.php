...
<head>
    ...
    <title>WeMakers Interiors & Designers</title>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <a href="index.html" class="logo d-flex align-items-center me-auto me-lg-0">
                <img src="{{asset('assets/images/makers-logo.png')}}" alt="">
            </a>
        ...
        <section class="py-5 why-us">
            <div class="container">
                <div class="row pb-5">
                    <div class="col-lg-12">
                        <div class="head">
                            <h1 class="sub-head text-center">Why Choose WeMaker's Designers?</h1>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-3 col-md-3 col-6">
                        <div class="row-section-1">
                            <div class="row-section-img">
                                <img src="https://media.designcafe.com/wp-content/uploads/2022/06/30141040/personalised-home-interiors.png" class="img-fluid" alt="">
                            </div>
